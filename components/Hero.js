...
const slides = [
  {
    ...
    emoji: "🛒",
    tag: "Welcome to Channi Goth's Finest",
    title: "Your Neighborhood\nKaryana Store",
    subtitle:
      "Fresh groceries, daily essentials & premium digital services — all under one roof in the heart of Channi Goth.",
  ...
  },
  {
    ...
    subtitle:
      "Ice-cold beverages, crunchy snacks, and sweet treats. The best brands, always in stock for you.",
    cta: "See Products",
    ctaLink: "#services",
  ...
  },
  {
    ...
    subtitle:
      "Pay utility bills, withdraw cash, and send money — fast, secure, and convenient digital services available 7 days a week.",
    cta: "Learn More",
    ctaLink: "#digital",
  ...
  },
  {
    ...
    subtitle:
      "Walls, Omore, and more — a full range of ice creams, popsicles, and frozen treats to keep your family smiling.",
    cta: "View Ice Creams",
    ctaLink: "#services",
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 min-h-screen flex items-center">
        <div
          className={`w-full pt-20 pb-28 sm:pt-24 sm:pb-20 transition-all duration-400 ${animating ? "opacity-0 translate-y-3" : "opacity-100 translate-y-0"}`}
        >
              ...
              <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-sm sm:max-w-none">
                {[
                  ...
                  <div key={stat.label} className="text-center">
                    <div className="font-display font-black text-lg sm:text-2xl gradient-text">
                      {stat.value}
                    </div>
                    <div className="text-white/60 text-[9px] sm:text-xs font-semibold uppercase tracking-wide leading-tight">
                      {stat.label}
                    </div>
                  </div>
                ))}
