        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="reveal-left">
            ...
            >
              ...
              <em style={{ color: "#0a5c2f", fontStyle: "italic" }}>
                A Community Hub
              </em>
            </h2>
            <div
            ...
            >
              Imran Karyana Store is Channi Goth's trusted neighbourhood store —
              combining fresh groceries, premium snacks, and cold drinks with
              modern digital payment services under one roof.
            </p>
            <p
              style={{
                fontFamily: "var(--font-outfit)",
            ...
            >
              As a tech-forward store, we integrate{" "}
              <strong style={{ color: "#0a5c2f" }}>Easypaisa</strong>,{" "}
              <strong style={{ color: "#0a5c2f" }}>JazzCash</strong>, and
              utility bill payments alongside quality groceries — making your
              life easier, one visit at a time.
            </p>
